...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  useEffect(() => {
    const loaded = StorageManager.getHeroSlides();
        ...
        <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 xl:gap-16 items-center">
                ...
                <div className="mt-4 pt-4 border-t border-stone-200/80 flex flex-wrap items-center justify-between gap-3 text-stone-700">
                  <div className="flex items-center gap-3">
                    <div className="flex -space-x-2">
                      ...
                      <img
                        className="inline-block h-8 w-8 rounded-full ring-2 ring-[#fbf8f4] object-cover"
                        src="https://picsum.photos/seed/1507003211169-0a1dd7228f2d/800/600"
                        alt="Customer Rohan M."
                      />
                      <img
                        className="inline-block h-8 w-8 rounded-full ring-2 ring-[#fbf8f4] object-cover"
                        src="https://picsum.photos/seed/1494790108377-be9c29b29330/800/600"
                        alt="Customer Ananya D."
                      />
                      <img
                        className="inline-block h-8 w-8 rounded-full ring-2 ring-[#fbf8f4] object-cover"
                        src="https://picsum.photos/seed/1500648767791-00dcc994a43e/800/600"
            ...
            <div className="lg:col-span-6 order-1 lg:order-2 space-y-6 text-left">
              ...
              {/* Atelier Badge */}
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-violet-50 text-violet-700 text-xs font-bold tracking-wide border border-violet-200">
                <span>Hand-Painted With</span>
                <Heart className="w-3.5 h-3.5 fill-violet-600 text-violet-600" />
              </div>

              {/* Display Headline */}
              <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-slate-900 leading-[1.08]">
                Passion.<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-700 via-indigo-700 to-purple-800">
                  Made for You.
                </span>
              </h1>
              ...
              <p className="text-slate-600 text-base sm:text-lg leading-relaxed max-w-xl font-normal">
                Professional artists transform your photo into a stunning <strong className="text-slate-900 font-semibold">hand-painted masterpiece</strong> using premium oil, acrylic, watercolor & pencil.
              </p>

              {/* Bullet Guarantees List / Feature Pills */}
              <div className="flex flex-wrap gap-2.5 pt-1">
                <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-slate-100 text-slate-800 text-xs font-semibold border border-slate-200 shadow-xs">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 pt-3">
                <button
                  ...
                  onClick={handleStart}
                  className="px-8 py-4 bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 text-white rounded-2xl font-bold text-base shadow-xl shadow-indigo-600/25 hover:-translate-y-0.5 active:translate-y-0 transition-all flex items-center justify-center gap-3 group"
                >
                  <Palette className="w-5 h-5 text-violet-200 group-hover:rotate-12 transition-transform" />
                ...
                <button
                  ...
                  className="px-7 py-4 bg-white hover:bg-slate-50 text-slate-800 border border-slate-300 rounded-2xl font-semibold text-base shadow-xs hover:border-slate-400 transition-all flex items-center justify-center gap-2"
                >
